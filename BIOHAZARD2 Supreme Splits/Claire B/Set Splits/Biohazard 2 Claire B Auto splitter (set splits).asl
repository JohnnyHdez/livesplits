...
else if(cur_segname == "First Form Birkin")
{
...
else if(cur_segname == "Control Room Key")
{
...
else if(cur_segname == "Master Key") 
{
  ...
  return current.SLOT06 == Master_Key || current.SLOT07 == Master_Key || current.SLOT05 == Master_Key || current.SLOT04 == Master_Key || current.SLOT03 == Master_Key;
}
